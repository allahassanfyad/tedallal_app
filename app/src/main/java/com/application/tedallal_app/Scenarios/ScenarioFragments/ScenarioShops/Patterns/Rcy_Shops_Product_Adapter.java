...
public class Rcy_Shops_Product_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements NetworkInterface {
    ...
    public Rcy_Shops_Product_Adapter(List<ModelAllProductByCategoreyResponse> rcypreviouslList, Context context) {
...
//                        x = 1;
                        ...
                        new Apicalls(context, Rcy_Shops_Product_Adapter.this).insert_Fav(saved_data.get_user_id(context), String.valueOf(songs.getId()));
