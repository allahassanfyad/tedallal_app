...
public class Alshal_Chat_Adapter extends FirestoreRecyclerAdapter<ChatItem, RecyclerView.ViewHolder> {
    ...
    public Alshal_Chat_Adapter(FirestoreRecyclerOptions<ChatItem> options, Context context) {
        super(options);
...
//        Passenger passenger = new Passenger();
        int sender = (int) options.getSnapshots().get(position).getSender();

        int user_id = 55667788;
