package com.application.tedallal_app.Scenarios.ScenarioMain.Controller.Ui_Fragments.ScenarioHomeFragment.Controller.UI_Home_Fragment.ScenarioHomeDetails.Model;//  ModelAllProductByCategoreyResponse.java
...
public class ModelAllProductByCategoreyResponse{
	...
	private  Boolean  isFavouret = false;

	public Boolean getFavouret() {
		return isFavouret;
	}

	public void setFavouret(Boolean favouret) {
		isFavouret = favouret;
	}
	...
	public ModelAllProductByCategoreyResponse() {
	}

	/**
	 * Instantiate the instance using the passed jsonObject to set the properties values
	 */
	public ModelAllProductByCategoreyResponse(JSONObject jsonObject){
		if(jsonObject == null){
			return;
		}
