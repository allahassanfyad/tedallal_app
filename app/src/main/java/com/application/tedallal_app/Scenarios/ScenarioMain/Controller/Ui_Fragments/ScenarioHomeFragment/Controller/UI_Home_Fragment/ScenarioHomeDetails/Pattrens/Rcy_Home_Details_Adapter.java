...
public class Rcy_Home_Details_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements NetworkInterface {
    ...
    public Rcy_Home_Details_Adapter(List<ModelAllProductByCategoreyResponse> rcypreviouslList, Context context) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        itemHome.txtpriceDiscoint.setText(songs.getPriceDiscount());
...
//             EnglishSongHolder songHolder =(EnglishSongHolder)Holder;
    ...
    public static class notificationHolder extends RecyclerView.ViewHolder {
        ...
        TextView txttitle, txtprice,txtpriceDiscoint;
...
//        ShimmerFrameLayout container;
        ...
        private notificationHolder(@NonNull View itemView) {
            ...
            txtpriceDiscoint = itemView.findViewById(R.id.txtPriceDiscount);
