...
public class Rcy_Best_Selling_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements NetworkInterface {
    ...
    public Rcy_Best_Selling_Adapter(List<ModelAllProductByCategoreyResponse> rcypreviouslList, Context context) {
...
//                        x = 1;
                        ...
                        new Apicalls(context, Rcy_Best_Selling_Adapter.this).insert_Fav(saved_data.get_user_id(context), String.valueOf(songs.getId()));
