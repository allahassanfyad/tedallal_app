...
public class Rcy_Recently_Added_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements NetworkInterface {
    ...
    public Rcy_Recently_Added_Adapter(List<ModelAllProductByCategoreyResponse> rcypreviouslList, Context context) {
...
//                        x = 1;
                        ...
                        new Apicalls(context, Rcy_Recently_Added_Adapter.this).insert_Fav(saved_data.get_user_id(context), String.valueOf(songs.getId()));
...
//                notifyDataSetChanged();
                ...
                Rcy_Best_Selling_Adapter.getback = 1;
                FragmentTransaction fr = ((AppCompatActivity) context).getSupportFragmentManager().beginTransaction();
                fr.replace(R.id.fragment_container, new Add_Cart_Fragment());
                fr.addToBackStack(null);
                fr.commit();
