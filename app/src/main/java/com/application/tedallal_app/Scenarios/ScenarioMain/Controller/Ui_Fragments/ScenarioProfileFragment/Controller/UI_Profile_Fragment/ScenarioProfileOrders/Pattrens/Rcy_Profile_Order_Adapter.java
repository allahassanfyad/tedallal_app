...
import com.application.tedallal_app.Scenarios.ScenarioMain.Controller.Ui_Fragments.ScenarioProfileFragment.Controller.UI_Profile_Fragment.ScenarioProfileOrders.Controller.Profile_Order_Details;
import com.application.tedallal_app.Utils.TinyDB;

import java.util.ArrayList;
import java.util.List;

public class Rcy_Profile_Order_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Rcy_Profile_Order_Adapter(List<ModelAllOrdersResponse> rcypreviouslList, Context context) {
...
//        itemHome.txtdate.setText(songs.getDatee());
        ...
        itemHome.btnorderdetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fr.replace(R.id.fragment_container2, new Profile_Order_Details());
